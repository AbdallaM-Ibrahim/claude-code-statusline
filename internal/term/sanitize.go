...
//
// Sanitize is the single choke point. Everything that reaches either line
...
// Sanitize drops every rune a terminal reads as a command rather than as text:
//
...
// needsSanitising decides whether Sanitize has to build a new string.
